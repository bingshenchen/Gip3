...
namespace GIP.PRJ.TraiteurApp.Services
{
    ...
    {
        private readonly ILogger<MailerCustomerService> _logger;
        private readonly IServiceScopeFactory _serviceScopeFactory;
        public MailerCustomerService(ILogger<MailerCustomerService> logger, IServiceScopeFactory serviceScopeFactory)
        {
            _logger = logger;
        ...
        public async Task DoWork()
        {
            using (var scope = _serviceScopeFactory.CreateScope())
            {
                ...
                var confirm = context.Customers
                    .Where(o => o.ConfirmationSent.Equals(false))
                    .ToList();



                // herinneringsmail sturen naar klanten
                foreach (var customer in confirm)
                {
